                            ...
                            <div class="x_content">
                                ...
                                <form id="basicInfoForm" class="form-horizontal form-label-left" method="post" enctype='multipart/form-data'>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            <input type="text" name="phone_number" class="form-control" value="<?php echo $login_user_detail->phone_number; ?>">
                                            <?php echo form_error('phone_number'); ?> 
                                        </div>
									</div>
                                    <input class="file-upload" name="profile_image" type="file" style="display: none" accept="image/*"/>
