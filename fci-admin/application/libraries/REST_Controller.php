...
abstract class REST_Controller extends CI_Controller {
    ...
    public function check_token($check_token_only = false) {
        ...
        if($check_token_only){
            ...
            $this->response(array('success'=>true,'msg'=>'Valid Token', 'is_week_started' => $user_details['is_week_started'],'name'=>$user_details['first_name'], 'arm'=>'study'), REST_Controller::HTTP_OK);
        }
    }
