...
export class PreviousNextButtonsComponent implements OnInit {
	...
	routes = [
		...
		//module 6
		{ module: '6', back: 'intro', current: 'fire-service/1', next: 'fire-service/2' },
		{ module: '6', back: 'fire-service/1', current: 'fire-service/2', next: 'fire-service/3' ,title:"Food Choices / Timing / Speed" },
		{ module: '6', back: 'fire-service/2', current: 'fire-service/3', next: 'fire-service/4' },
		{ module: '6', back: 'fire-service/3', current: 'fire-service/4', next: 'fire-service/5' },
		{ module: '6', back: 'fire-service/4', current: 'fire-service/5', next: 'fire-service/6' },
		{ module: '6', back: 'fire-service/5', current: 'fire-service/6', next: 'fire-service/7' },
		{ module: '6', back: 'fire-service/6', current: 'fire-service/7', next: 'fire-service/8' },
		{ module: '6', back: 'fire-service/7', current: 'fire-service/8', next: 'fire-service/9' },
		{ module: '6', back: 'fire-service/8', current: 'fire-service/9', next: 'fire-service/10' },
		{ module: '6', back: 'fire-service/9', current: 'fire-service/10', next: 'fire-service/11' },
		{ module: '6', back: 'fire-service/10', current: 'fire-service/11', next: 'fire-service/12' },
		{ module: '6', back: 'fire-service/11', current: 'fire-service/12', next: 'fire-service/13' },
		{ module: '6', back: 'fire-service/12', current: 'fire-service/13', next: 'fire-service/14' },
		{ module: '6', back: 'fire-service/13', current: 'fire-service/14', next: 'fire-service/15' },
		{ module: '6', back: 'fire-service/14', current: 'fire-service/15', next: 'fire-service/16' },
		{ module: '6', back: 'fire-service/15', current: 'fire-service/16', next: 'fire-service/17' },
		{ module: '6', back: 'fire-service/16', current: 'fire-service/17', next: 'fire-service/18' },
		{ module: '6', back: 'fire-service/17', current: 'fire-service/18', next: 'fire-service/19' },
		{ module: '6', back: 'fire-service/18', current: 'fire-service/19', next: 'fire-service/20' },
		{ module: '6', back: 'fire-service/19', current: 'fire-service/20', next: 'intro' },
